...
with open('dados2_contadores.json', 'r', encoding='utf-8') as file:
    dados = json.load(file)

registro = dados[0]

# Lista de nomes dos contadores
contadores = [cont["nome"] for cont in registro["contagens"]]

# Histórico de eventos (ex: [1, 1, 2, 1, 2, 1, 1, 2, 2, 1])
...
# ==== Interface Tkinter ====
root = tk.Tk()
root.title(f"Gráfico de Contadores - {registro['titulo']}")
...
def atualizar_grafico():
    ...
    if modo == "Linha":
        ...
        ax.bar(contadores, valores, color=['blue','orange','green','yellow','purple'])
